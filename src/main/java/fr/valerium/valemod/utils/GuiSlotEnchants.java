...
public abstract class GuiSlotEnchants
{
    ...
    public GuiSlotEnchants(Minecraft p_i1052_1_, int p_i1052_2_, int p_i1052_3_, int p_i1052_4_, int p_i1052_5_, int p_i1052_6_)
    {
        this.mc = p_i1052_1_;
    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int p_148120_3_, int p_148120_4_)
    {
        ...
        for (int j1 = 0; j1 < i1; ++j1)
        {
            ...
            if (k1 <= this.bottom && k1 + l1 >= this.top)
            {
                ...
                {
                    // Modification ici pour utiliser des coordonnées relatives
                    int boxX = (int)(this.left + 10);
                    int boxY = (int)(this.top * 10);
                    int boxWidth = (int)(this.width * 0.20);
                    int boxHeight = (int)(this.slotHeight * 1);

                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                    GL11.glDisable(GL11.GL_TEXTURE_2D);
                    tessellator.startDrawingQuads();
                    tessellator.setColorOpaque_I(8421504);
                    tessellator.addVertex(boxX, boxY + boxHeight, 0.0D);
                    tessellator.addVertex(boxX + boxWidth, boxY + boxHeight, 0.0D);
                    tessellator.addVertex(boxX + boxWidth, boxY, 0.0D);
                    tessellator.addVertex(boxX, boxY, 0.0D);
                    tessellator.setColorOpaque_I(0);
                    tessellator.addVertex(boxX + 1, boxY + boxHeight - 1, 0.0D);
                    tessellator.addVertex(boxX + boxWidth - 1, boxY + boxHeight - 1, 0.0D);
                    tessellator.addVertex(boxX + boxWidth - 1, boxY + 1, 0.0D);
                    tessellator.addVertex(boxX + 1, boxY + 1, 0.0D);
                    tessellator.draw();
                    GL11.glEnable(GL11.GL_TEXTURE_2D);
