...
public class RuneCrafterCraftingManager
{
    /** The static instance of this class */
    private static final RuneCrafterCraftingManager instance = new RuneCrafterCraftingManager();
     ...
     */
    public static final RuneCrafterCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private RuneCrafterCraftingManager()
    {
        this.addRecipe(new ItemStack(ModItems.random_ring, 1), new Object[] {" # ","#X#", " # ", '#', ModItems.valerium_ingot, 'X', ModItems.legendary_rune});
