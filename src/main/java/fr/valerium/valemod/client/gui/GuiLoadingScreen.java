...
public class GuiLoadingScreen
  extends GuiScreen
{
  private final ResourceLocation backGround = new ResourceLocation(Reference.MOD_ID + ":textures/gui/background.jpg");
  ...
  public void initGui()
  {
    this.buttonList.add(new ButtonMenu(9, this.width - 100, this.height - 30, 60, 20, "Annuler"));
  }
  ...
  public void updateScreen()
  {
    ...
    if (this.updateCounter == 100) {
      this.mc.displayGuiScreen(new GuiConnecting(this, this.mc, "localhost", 41664)); // Ip = L'ip du serveur ! Port = Port du serveur.
    }
