...
public class ButtonList extends GuiButton {
	...
	private ResourceLocation buttonTexture = new ResourceLocation("valerium:textures/gui/ButtonList.png");
	private ResourceLocation buttonTextureHover = new ResourceLocation("valerium:textures/gui/ButtonListHover.png");
	
	public ButtonList(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
	...
	public void drawButton(Minecraft mc, int i1, int i2) {
		...
		if(mouseDragged) {
			...
			mc.getTextureManager().bindTexture(buttonTextureHover);
		}
		int i3 = this.getHoverState(mouseDragged);
		int l = 14737632;
		
		func_146110_a(this.xPosition, this.yPosition, 0, 0, this.width, this.height, 50, 12);
