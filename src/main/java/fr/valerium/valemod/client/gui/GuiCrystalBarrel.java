...
public class GuiCrystalBarrel extends GuiContainer {

	private ResourceLocation background = new ResourceLocation("valerium", "textures/gui/container/diamond.png");
	FontRenderer fr;

	private TileEntityCrystalBarrel tile;

	public GuiCrystalBarrel(TileEntityCrystalBarrel tile, InventoryPlayer inventory) {
	    super((Container)new ContainerCrystalBarrel(tile, inventory));
	    this.tile = tile;
	    this.ySize = 256;
	    this.xSize = 256;
