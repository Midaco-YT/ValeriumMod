...
public class ButtonJobs extends GuiButton {

	private ResourceLocation buttonTexture = new ResourceLocation("valerium:textures/gui/jobs/jobsbutton.png");
	
	public ButtonJobs(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
	...
	public void drawButton(Minecraft mc, int i1, int i2) {
		...
		this.drawTexturedModalRect(this.xPosition, this.yPosition, 11, 0 + i3 * 0, this.width / 2, this.height);
		this.drawTexturedModalRect(this.xPosition + 23, this.yPosition, 11, 0 + i3 * 0, this.width / 2, this.height);
