...
public class GuiMainMenuCustom extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation logo = new ResourceLocation(Reference.MOD_ID + ":textures/gui/icon.png");
    ...
    public void initGui() 
    {
        ...
        this.buttonList.add(new ButtonMenu(0, this.width / 2 - 100, var3 + 72 + 12, 98, 20, I18n.format(EnumChatFormatting.GOLD + "Options")));
        this.buttonList.add(new ButtonMenu(4, this.width / 2 + 2, var3 + 72 + 12, 98, 20, I18n.format(EnumChatFormatting.RED + "Quitter")));
    ...
    {
    	this.buttonList.add(new ButtonMenu(1, this.width / 2 -100 , p_73969_1_ + 60, 200, 20, I18n.format(EnumChatFormatting.DARK_PURPLE + "Solo")));
        this.buttonList.add(new ButtonMenu(19, this.width / 2 - 100, p_73969_1_ + 35, 200, 20, I18n.format(EnumChatFormatting.DARK_RED + "Rejoindre Valerium")));
    }
    ...
    { 	
        ...
        this.drawTextureWithOptionalSize(width / 2 - 95, height / 4 - 20, 0, 0, 200, 40, 200, 40);
    }
