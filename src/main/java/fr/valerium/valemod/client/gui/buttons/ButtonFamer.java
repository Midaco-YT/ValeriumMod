...
public class ButtonFamer extends GuiButton {

	private ResourceLocation FARMER_ICON = new ResourceLocation("valerium:textures/gui/jobs/icon/Farmer.png");
	private ResourceLocation FARMER_ICON_HOVER = new ResourceLocation("valerium:textures/gui/jobs/icon/FarmerHover.png");
	
	public ButtonFamer(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
	...
	public void drawButton(Minecraft mc, int i1, int i2) {
		...
		mc.getTextureManager().bindTexture(FARMER_ICON);
		...
		if(mouseDragged) {
			...
			mc.getTextureManager().bindTexture(FARMER_ICON_HOVER);
		}
