...
public class ButtonCustom extends GuiButton {
	...
	private ResourceLocation buttonTexture = new ResourceLocation("valerium:textures/gui/element_hdv2.png");
	
	public ButtonCustom(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
